...
// Der Speicher Check soll aus Performancegründen nur im Debug Modus stattfinden
     ...
     * Wrapper für strdup
     * 
     * @param[in] string String, der dupliziert werden soll
     * @param[in] file Datei, in der die Funktion aufgerufen wird
     * @param[in] line Zeile, in der die Funktion aufgerufen wird
     * 
     * @return Adresse des neuen Strings
     * 
     * @see strdup in stdlib.h
     */
    char* fhwcg_strdup(const char* string, const char* file, int line);

    /**
     * Wrapper für glCreateVertexArrays
     * 
     * @param[in] n Anzahl an zu erzeugenden Elementen
     * @param[in] arrays Hier werden die IDs abgelegt
     * 
     * @see glCreateVertexArrays()
     */
    void fhwcg_glCreateVertexArrays(GLsizei n, GLuint* arrays);
     ...
     * @see glCreateBuffers()
     */
    void fhwcg_glCreateBuffers(GLsizei n, GLuint* buffers);
    ...
    /**
     * Wrapper für glCreateTextures
     * 
     * @param[in] target Das Texture Target (GL_TEXTURE_2D, GL_TEXTURE_CUBE_MAP ...)
     * @param[in] n Anzahl an zu erzeugenden Elementen
     * @param[in] textures Hier werden die IDs abgelegt
     * 
     * @see glCreateTextures()
     */
    void fhwcg_glCreateTextures(GLenum target, GLsizei n, GLuint* textures);
    ...
    /**
     * Wrapper für glCreateFramebuffers
     * 
     * @param[in] n Anzahl an zu erzeugenden Elementen
     * @param[in] ids Hier werden die IDs abgelegt
     * 
     * @see glCreateFramebuffers()
     */
    void fhwcg_glCreateFramebuffers(GLsizei n, GLuint* ids);
    ...
    /**
     * Wrapper für glCreateRenderbuffers
     * 
     * @param[in] n Anzahl an zu erzeugenden Elementen
     * @param[in] renderbuffers die IDs
     * 
     * @see glCreateRenderbuffers()
     */
    void fhwcg_glCreateRenderbuffers(GLsizei n, GLuint* renderbuffers);

    /**
     * Wrapper für glDeleteRenderbuffers
     * 
     * @param[in] n Anzahl an freizugebenden Elementen
     * @param[in] renderbuffers die IDs
     * 
     ...
     */
    void fhwcg_glDeleteRenderbuffers(GLsizei n, GLuint* renderbuffers);
    ...
    /** Anstatt strdup rufen wir unseren Wrapper auf */
    #define strdup(string) fhwcg_strdup(string, __FILE__, __LINE__)

    /** Anstatt glCreateVertexArrays rufen wir unseren Wrapper auf */
    #define glCreateVertexArrays(n, arrays) fhwcg_glCreateVertexArrays(n, arrays)
    ...
    /** Anstatt glCreateBuffers rufen wir unseren Wrapper auf */
    #define glCreateBuffers(n, buffers) fhwcg_glCreateBuffers(n, buffers)
    ...
    /** Anstatt glCreateTextures rufen wir unseren Wrapper auf */
    #define glCreateTextures(target, n, textures) fhwcg_glCreateTextures(target, n, textures)
    ...
    /** Anstatt glCreateFramebuffers rufen wir unseren Wrapper auf */
    #define glCreateFramebuffers(n, ids) fhwcg_glCreateFramebuffers(n, ids)
    ...
    /** Anstatt glCreateRenderbuffers rufen wir unseren Wrapper auf */
    #define glCreateRenderbuffers(n, renderbuffers) fhwcg_glCreateRenderbuffers(n, renderbuffers)

    /** Anstatt glDeleteRenderbuffers rufen wir unseren Wrapper auf */
    #define glDeleteRenderbuffers(n, renderbuffers) fhwcg_glDeleteRenderbuffers(n, renderbuffers)
