...
/**
 * Berechnet die benötigten Mip Levels für automatisch erzeugte Mipmaps.
 * 
 * @param[in] width Breite der Textur
 * @param[in] height Höhe der Textur
 * 
 * @return Anzahl an Mip Levels
 */
uint utils_getMipLevels(uint width, uint height);
