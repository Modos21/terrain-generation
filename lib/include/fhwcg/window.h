...
/**
 * Liefert die Skalierung des Fensters
 * 
 * @param[in] ctx Programmkontext
 * 
 * @return Skalierungsfaktor
 */
float window_getScaling(ProgContext ctx);
